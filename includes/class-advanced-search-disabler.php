 ...
 */
class Advanced_Search_Disabler {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Advanced_Search_Disabler_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected Advanced_Search_Disabler_Loader $loader;
	...
	public function __construct() {
		if ( defined( 'ADVANCED_SEARCH_DISABLER_VERSION' ) ) {
			$this->version = ADVANCED_SEARCH_DISABLER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'advanced-search-disabler';
	 ...
	 *
	 * - Advanced_Search_Disabler_Loader. Orchestrates the hooks of the plugin.
	 * - Advanced_Search_Disabler_i18n. Defines internationalization functionality.
	 * - Advanced_Search_Disabler_Admin. Defines all hooks for the admin area.
	 * - Advanced_Search_Disabler_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Advanced_Search_Disabler_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
